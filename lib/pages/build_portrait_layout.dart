    ...
    body: SafeArea(
      child: Stack(
        children: [
          ...
          buildCircleIndicator(context: context, currentPageNotifier: currentPageNotifier, size: size),
        ],
      ),
    ),
  );
...
buildCircleIndicator({required BuildContext context, required currentPageNotifier, required Size size}) {
  int itemCount = 2;
  return Positioned(
    left: 0.0,
    right: 0.0,
